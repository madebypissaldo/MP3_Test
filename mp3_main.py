...
while True:
    ...
    if genero == "1":
        ...
        if musica == 'd1'.strip().lower():
            try:
                pygame.mixer.music.load('ytmp3-converter.com_320kbps-central-cee-doja-official-music-video.mp3')
            ...
            try:
                pygame.mixer.music.load('ytmp3-converter.com_320kbps-irish-drill.mp3')
                pygame.mixer.music.set_volume(1.0)
                pygame.mixer.music.play()
                while True:
                    for event in pygame.event.get():
        ...
        if musica == 'c1'.strip().lower():
            try:
                pygame.mixer.music.load('ytmp3-converter.com_320kbps-peso-pluma-bzrp-music-sessions-55.mp3')
                pygame.mixer.music.set_volume(1.0)
                pygame.mixer.music.play()
                while True:
                    for event in pygame.event.get():
            ...
            try:
                pygame.mixer.music.load('ytmp3-converter.com_320kbps-fuerza-regida-tqm.mp3')
                pygame.mixer.music.set_volume(1.0)
                pygame.mixer.music.play()
                while True:
                    for event in pygame.event.get():
        ...
        if musica == 'r1'.strip().lower():
            try:
                pygame.mixer.music.load('ytmp3-converter.com_320kbps-frank-ocean-ivy.mp3')
                pygame.mixer.music.set_volume(1.0)
                pygame.mixer.music.play()
                while True:
                    for event in pygame.event.get():
            ...
            try:
                pygame.mixer.music.load('ytmp3-converter.com_320kbps-the-weeknd-after-hours-audio.mp3')
                pygame.mixer.music.set_volume(1.0)
                pygame.mixer.music.play()
                while True:
                    for event in pygame.event.get():
